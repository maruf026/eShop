            ...
            >
              ...
              <Link to={`/products/${product.id}`}>
                <div className="relative overflow-hidden bg-gray-50">
                  ...
                  {/* Badge */}
                  <span
                    className={`absolute top-3 left-3 ${product.badgeColor} text-white text-xs font-semibold px-2 py-1 rounded`}
                  >
                    {product.badge}
                  </span>
              ...
              <div className="p-4">
                ...
                <button
                  ...
                  className="w-full bg-orange-400 text-white py-2.5 rounded-lg font-semibold hover:bg-orange-700 transition flex items-center justify-center gap-2"
                >
                  <FiShoppingCart />
                  Add to Cart
                </button>
